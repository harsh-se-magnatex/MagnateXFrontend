...
export function BoostRecommendationCard({
  ...
  return (
    <div className="space-y-4 rounded-xl border border-violet-200 bg-white p-4 shadow-sm">
      <header className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="text-xs leading-relaxed text-zinc-600">{subhead}</p>
        </div>
      ...
      {card.postPreview ? (
        <div className="flex gap-3 rounded-lg border border-violet-100 bg-violet-50/40 p-3">
          {card.postPreview.mediaUrl ? (
            ...
            <div
              className="flex h-20 w-20 shrink-0 items-center justify-center rounded-md bg-white text-violet-400"
              aria-hidden
            >
      ...
      <div className="grid gap-2 rounded-lg border border-zinc-200 bg-zinc-50/60 p-3 text-xs sm:grid-cols-3">
        <div>
      ...
      <div>
        <div className="mb-2 flex items-center justify-between gap-2">
          ...
          {card.targetingSource === 'openai' ? (
            <Badge
              variant="outline"
              className="gap-1 border-violet-300 bg-violet-50 text-[10px] font-medium text-violet-800"
            >
        ...
        {card.rationale ? (
          <p className="mt-3 rounded-md border border-violet-100 bg-violet-50/60 px-3 py-2 text-[11px] leading-relaxed text-violet-900">
            {card.rationale}
          </p>
        ) : null}
      </div>

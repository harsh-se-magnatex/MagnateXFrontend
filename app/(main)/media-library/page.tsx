...
const SOURCE_OPTIONS: {
  ...
  },
  {
    ...
    label: 'Bulk Creator',
    description: 'Posts from Bulk Creator',
  },
  {
    value: 'productadvert',
    label: 'Product Ads',
  ...
  {
    value: 'eventPosts',
    label: 'Holiday & Festival Posts',
    description: 'Posts from Holiday & Festival Posts',
  },
  {
 ...
 * "Generated by …" wording as `/scheduled-post` (e.g. "Content Studio",
 * "Bulk Creator", "AI Engine"). Campaign drafts have no native generatedBy
...
export default function MediaLibraryPage() {
  ...
  const emptyCopy = useMemo(() => {
    if (source === 'all') {
      return 'Generated images from Content Studio, Carousel Posts, Bulk Creator, and Product Ads will appear here.';
    }
    ...
    if (source === 'batchGeneratedPosts') {
      return 'Bulk Creator posts with images show up after the workflow creates scheduled posts.';
    }
    ...
    if (source === 'eventPosts') {
      return 'Holiday & Festival Posts with images are listed here.';
    }
